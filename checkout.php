    ...
    if (isset($_GET['get_id'])) {
        ...
        if ($get_product->rowCount() > 0) {
            while ($fetch_p = $get_product->fetch(PDO::FETCH_ASSOC)) {
                ...
                $insert_order = $conn->prepare("INSERT INTO orders (id, user_id, seller_id, name, number, email, address, 
        ...
        while ($f_cart = $verify_cart->fetch(PDO::FETCH_ASSOC)) {
            ...
            $insert_order = $conn->prepare("INSERT INTO orders (id, user_id, seller_id, name,
                        number, email, address, address_type, method, product_id, price, qty) 
                        VALUES (?,?,?,?,?,?,?,?,?,?,?,?)");
            $insert_order->execute([
                unique_id(),
                $user_id,
                    ...
                    <div class="box">
                        <div class="input-field">
                            ...
                            <input type="text" name="flat" required maxlength="50"
                                placeholder="e.g Flat or building name" class="input">
                        </div>
                        <div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="country" required maxlength="50" placeholder="e.g Country name"
                                class="input" value="INDIA" disabled>
                        </div>
                        <div class="input-field">
                            <p>pincode<span>*</span></p>
                            <input type="number" name="pin" required maxlength="6" min="6" placeholder="e.g 101011"
                                class="input">
                        </div>
                    </div>
                </div>
